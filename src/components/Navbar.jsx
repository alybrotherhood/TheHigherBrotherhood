...
const NavLinks = () => (
  <ul className='absolute left-0 top-full w-full lg:static flex flex-col lg:flex-row gap-12 bg-mainColor text-2xl text-white text-center uppercase font-medium py-10 lg-py-0'>
    <li><a href="/" className='lg:bg-secondaryColor px-6 py-4 rounded-full text-secondaryColor lg:text-mainColor font-bold whitespace-nowrap'>Join Now</a></li>
    <li><a href="/">About</a></li>
    <li><a href="#testimonials">Testimonials</a></li>
    <li><a href="/blog">Blog</a></li>
    <li><a href="/contact">Contact</a></li>
    <li><a href="/login" className='lg:bg-secondaryColor px-6 py-4 rounded-full text-secondaryColor lg:text-mainColor font-bold'>Login</a></li>
  </ul>
);
...
const Navbar = () => {
  ...
  return (
    <nav className='relative flex justify-center items-center bg-mainColor py-10'>
      {
